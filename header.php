	...
	<div id="wrapper" class="hfeed">
		...
		<header id="header" class="w3-white w3-card" role="banner">
		  <div class="w3-bar">
				...
				<!-- Mobile Menu Button -->
		    <a class="w3-bar-item w3-button w3-padding-large w3-hide-medium w3-hide-large w3-right" href="javascript:void(0)" onclick="document.getElementById('mobilemenu').classList.toggle('w3-show')" title="Toggle Navigation Menu">
				...
				<div id="branding" class="w3-bar-item">
				...
				<?php if ( has_nav_menu( 'primary' ) ) : ?>
					...
					<!-- Large Screen Menu -->
					<nav id="menu" class="w3-right w3-hide-small" role="navigation">
